...
def cisco(port):
    ...
    if port_status == False:
        ...
        data_read = CaptureOutputOfCommand("show ip dhcp snooping binding interface fastEthernet 0/" + port,
...
def DZS(port):
    ...
    data_read = CaptureOutputOfCommand("show ip dhcp snooping binding ethernet 0/" + port,
